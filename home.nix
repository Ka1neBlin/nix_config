...
hl.bind("F7", hl.dsp.exec_cmd("noctalia msg media toggle"))
hl.bind("F5", hl.dsp.exec_cmd("noctalia msg media previos"))
hl.bind("F6", hl.dsp.exec_cmd("noctalia msg media next"))
hl.bind("F8", hl.dsp.exec_cmd("noctalia msg media stop"))
